...
const RUNTIME_API_BASE_STORAGE_KEY = 'anygo.runtime.api_base_url'
const RUNTIME_AMAP_WEB_JS_KEY_STORAGE_KEY = 'anygo.runtime.amap_web_js_key'
const RUNTIME_GOOGLE_MAPS_API_KEY_STORAGE_KEY = 'anygo.runtime.google_maps_api_key'
...
export const RUNTIME_SETTINGS_UPDATED_EVENT = 'anygo:runtime-settings-updated'
